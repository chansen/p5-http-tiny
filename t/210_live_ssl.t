...
my $data = {
    'https://www.google.ca/' => {
        ...
        pass => {
            ...
            SSL_verifycn_name   => 'www.google.ca',
    ...
    'https://spinrite.com/' => {
        ...
        pass => {
            ...
            SSL_verifycn_name   => 'spinrite.com',
...
while ( my ( $url, $data ) = each %$data ) {
    subtest $url => sub {
        ...
        is $response->{success}, $data->{default_should_yield},
